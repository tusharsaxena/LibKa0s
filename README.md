...
| `LibKa0s-DebugLog-1.0` | The on-screen debug console: movable window, color-coded log, copy box, and the one seam that turns logging on and off. | `DebugLog.lua` | [14](docs/api/DebugLog/version-14-docs.md) |
