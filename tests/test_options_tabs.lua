...
-- `opts` fields and the banner's `action` are pinned in tests/test_options_tabbed.lua, split out of
-- this file in the 2026-09-26 automated-tests sweep.
--
...
-- The tabbed page's `opts` and the banner's action button are in tests/test_options_tabbed.lua.
