-- tests/test_slash.lua — the dispatcher, the help renderer, the formatters, the CLI verbs and the
-- format hook. The parser is tests/test_slash_parse.lua and the disabled gate
-- tests/test_slash_disabled.lua, both split out of this file in the 2026-09-26 automated-tests sweep.
...
-- ParseBool and the parser are in tests/test_slash_parse.lua.
