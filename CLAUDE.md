...
LibKa0s adheres to the **Ka0s WoW Addon Standard** (v2.57.0) —
...
[#7](https://github.com/tusharsaxena/LibKa0s/issues/7)), `tests/test_options.lua` (1303), and, since v1.34.0, `tests/test_slash.lua` (1302 at v1.41.0, with Slash minor 13's restored disabled-surface cases; 1265 at minor 12, 1054 before the gate), and `LibKa0s/Widgets.lua` (1232). They are
