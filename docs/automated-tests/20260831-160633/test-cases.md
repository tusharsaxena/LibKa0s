...
- widgets: __tabBand places the baseline under the last row and reserves past it
- widgets: TabStrip draws one button per tab, marks the active one, and reserves the band
- widgets: a tab is cut from the client's own tab art, and the selected one hangs lower
