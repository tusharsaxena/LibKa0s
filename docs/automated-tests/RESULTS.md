...
[`20260917-005828/test-cases.md`](20260917-005828/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Unchanged from the previous run at 1141 cases.
...
Current as of [`20260917-005828`](20260917-005828/) — **this run's measurement, not its diff.** Max CCN **15** across 3171
