...
**1154 cases** — 1154 passed, 0 failed, 0 skipped. The generated inventory
[`20260917-201018/test-cases.md`](20260917-201018/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Moved **1141 → 1154** since the previous run.
...
Current as of [`20260917-201018`](20260917-201018/) — **this run's measurement, not its diff.** Max CCN **15** across 3209
