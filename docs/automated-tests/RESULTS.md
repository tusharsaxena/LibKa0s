...
**909 cases** — 909 passed, 0 failed, 0 skipped. The generated inventory
[`20260913-002423/test-cases.md`](20260913-002423/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Moved **897 → 909** since the previous run.
...
Current as of [`20260913-002423`](20260913-002423/) — **this run's measurement, not its diff.** Max CCN **14** across 2425
