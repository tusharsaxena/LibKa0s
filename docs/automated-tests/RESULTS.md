...
**1195 cases** — 1195 passed, 0 failed, 0 skipped. The generated inventory
[`20260919-214428/test-cases.md`](20260919-214428/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Moved **1189 → 1195** since the previous run.
...
Current as of [`20260919-214428`](20260919-214428/) — **this run's measurement, not its diff.** Max CCN **15** across 3351
