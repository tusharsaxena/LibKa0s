...
**1140 cases** — 1140 passed, 0 failed, 0 skipped. The generated inventory
[`20260916-212818/test-cases.md`](20260916-212818/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Moved **1071 → 1140** since the previous run.
...
**0 warnings / 0 errors over 65 files** (`luacheck .`).
...
Current as of [`20260916-212818`](20260916-212818/) — **this run's measurement, not its diff.** Max CCN **15** across 3171
