...
[`20260916-093057/test-cases.md`](20260916-093057/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Unchanged from the previous run at 1044 cases.
...
Current as of [`20260916-093057`](20260916-093057/) — **this run's measurement, not its diff.** Max CCN **14** across 2929
