...
**1485 cases** — 1484 passed, 0 failed, 1 skipped. The generated inventory
[`20260923-144526/test-cases.md`](20260923-144526/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Moved **1277 → 1485** since the previous run.
...
**0 warnings / 0 errors over 81 files** (`luacheck .`).
...
Current as of [`20260923-144526`](20260923-144526/) — **this run's measurement, not its diff.** Max CCN **15** across 4248
functions, **0** of them warned on; 10 file(s) in the 1000–1500 band and 3 over the 1500 cap
(`layout-§1`).
...
| 1000–1500 (on notice) | `testkit/test_prose.lua` | 1499 |  |
...
| 1000–1500 (on notice) | `tests/test_schema.lua` | 1233 |  |
...
| > 1500 (over cap) | `testkit/framework.lua` | 1583 |  |
