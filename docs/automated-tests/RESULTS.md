...
[`20260916-230957/test-cases.md`](20260916-230957/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Moved **1140 → 1141** since the previous run.
...
Current as of [`20260916-230957`](20260916-230957/) — **this run's measurement, not its diff.** Max CCN **15** across 3171
