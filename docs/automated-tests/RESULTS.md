...
**1028 cases** — 1028 passed, 0 failed, 0 skipped. The generated inventory
[`20260914-010923/test-cases.md`](20260914-010923/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Moved **1020 → 1028** since the previous run.
...
Current as of [`20260914-010923`](20260914-010923/) — **this run's measurement, not its diff.** Max CCN **14** across 2891
