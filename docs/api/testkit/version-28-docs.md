...
| First released in | unreleased — superseded by revision 29 before v1.62.0 was cut |
| Status | Superseded |
| Supersedes | [version 27](version-27-docs.md) — the shared diagnostics contract |
| Superseded by | [version 29](version-29-docs.md) — the prose gate's machinery and self-tests beside it |
