...
| Version | Files | Shipped in | Status |
|---|---|---|---|
| [23.26.3.7.3](./Options/version-23.26.3.7.3-docs.md) | `Options.lua` 23 · `OptionsWidgets.lua` 26 · `OptionsTabs.lua` 3 · `OptionsCompose.lua` 7 · `OptionsScroll.lua` 3 | v1.49.1 | **Current** |
