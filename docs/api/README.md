...
| Version | Files | Shipped in | Status |
|---|---|---|---|
| [24.30.3.7.4](./Options/version-24.30.3.7.4-docs.md) | `Options.lua` 24 · `OptionsWidgets.lua` 30 · `OptionsTabs.lua` 3 · `OptionsCompose.lua` 7 · `OptionsScroll.lua` 4 | v1.56.0 | **Current** |
