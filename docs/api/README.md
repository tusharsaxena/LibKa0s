...
| Version | Files | Shipped in | Status |
|---|---|---|---|
| [23.27.3.7.3](./Options/version-23.27.3.7.3-docs.md) | `Options.lua` 23 · `OptionsWidgets.lua` 27 · `OptionsTabs.lua` 3 · `OptionsCompose.lua` 7 · `OptionsScroll.lua` 3 | v1.50.0 | **Current** |
