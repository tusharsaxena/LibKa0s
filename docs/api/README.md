...
|---|---|---|---|
| [30](./testkit/version-30-docs.md) | same files; `run-automated-tests.sh` prints `None.`, under a blank line, below the header of an empty complexity watch-list table (warned functions, or files by `layout-§1` band) in `RESULTS.md`, where revisions 26 to 29 printed the header alone (the 2026-09-26 sweep's ATS-20). No member, case name or mock changes | v1.62.0 | **Current** |
