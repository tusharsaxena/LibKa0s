...
|---|---|---|---|
| Repo semver (`v1.9.0`) | git tag, `CHANGELOG.md` heading | humans | once per release |
...
**`media/` is the first payload that is not code**, and it changes two things about copying. The
...
> Bundles [LibKa0s](https://github.com/tusharsaxena/LibKa0s) v1.9.0 (MIT).
