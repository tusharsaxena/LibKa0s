...
|---|---|---|---|
| Repo semver (`v1.15.0`) | git tag, `CHANGELOG.md` heading | humans | once per release |
...
| `LibKa0s-Pool-1.0` | none yet | Shipped in v1.15.0. No consumer looks it up yet. Adoption is `06_PLAN_D_POOL_AND_ITEM_ADOPTION.md`, BankLedger and LootHistory |
