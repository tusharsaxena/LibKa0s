...
|---|---|---|---|
| Repo semver (`v1.29.0`) | git tag, `CHANGELOG.md` heading | humans | once per release |
...
1. **Make the change**, with its test. Green gate: `lua tests/run.lua` and `luacheck .` (0/0).
   ...
   is forty-nine files since v1.29.0: everything but `tests/_kit/`, which is excluded only because
