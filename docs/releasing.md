...
|---|---|---|---|
| Repo semver (`v1.56.0`) | git tag, `CHANGELOG.md` heading | humans | once per release |
...
**Where v1.56.0 stands (2026-09-24).** Twelve majors' minors move and none is added: Core 8, Item 2,
...
this release's own step 8, which waits on the owner's approval of the merge and the tag push (see
*Where v1.56.0 stands* above).
