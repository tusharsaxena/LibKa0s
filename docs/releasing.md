...
|---|---|---|---|
| Repo semver (`v1.17.0`) | git tag, `CHANGELOG.md` heading | humans | once per release |
...
| `LibKa0s-Env-1.0` | none yet | Shipped in v1.15.0. No consumer looks it up: this sweep prints nothing for it, and the payload has not been re-vendored yet (Task 8). Adoption is `05_PLAN_C_ENV_ADOPTION.md`, nine addons |
...
| `LibKa0s-Item-1.0` | none yet | Shipped in v1.15.0. No consumer looks it up yet. Adoption is `06_PLAN_D_POOL_AND_ITEM_ADOPTION.md`, BankLedger and LootHistory |
